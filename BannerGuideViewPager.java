...
public class BannerGuideViewPager extends FrameLayout {
    ...
    public BannerGuideViewPager(Context context) {
        this(context, null);
    }

    public BannerGuideViewPager(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BannerGuideViewPager(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            }
//            Log.e("BannerGuideViewPager", "mLinearLayoutMeasuredWidth:" +
//                    mLinearLayoutMeasuredWidth);
